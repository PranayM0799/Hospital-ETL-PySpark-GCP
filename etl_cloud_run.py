...
def main():
    ...
    try:
        ...
        download_csv_from_gcs(raw_bucket, 'data/raw/treatments.csv', '/tmp/treatments.csv')
        ...
        download_csv_from_gcs(raw_bucket, 'data/raw/hospital data analysis.csv', '/tmp/hospital_analysis.csv')
